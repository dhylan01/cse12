...
public class RPSTester {
    ...
    public void testPlayTies() {
        ...
        assertEquals( 0, rpsGame.determineWinner("paper", "paper"));
    ...
    public void testPlayPokemon() {
        ...
        assertEquals(false, !pokemonGame.isValidMove("fire"));
        assertEquals( 1, pokemonGame.determineWinner("water", "fire"));
